...
public class RepositoryTest {
    ...
    // Verify Notification keeps old value when subsequent call fails.
    @Test
    public void givenNotificationDataLoaded_whenNextCallFails_thenKeepOldData() {
    ...
    // Verify Record keeps old value when subsequent call fails.
    @Test
    public void givenRecordDataLoaded_whenNextCallFails_thenKeepOldData() {
    ...
    // Test Case ID: TC-REPO-013
    // Verify Appointment readAll HTTP error emits null and turns off animation.
    @Test
    public void givenAppointmentReadAll_whenApiHttpError_thenEmitNullAndStopAnimation() {
        AppointmentRepository repositoryUnderTest = new AppointmentRepository();
        Call<AppointmentReadAll> mockApiCall = mockCall();
    ...
    // Test Case ID: TC-REPO-014
    // Verify Appointment readAll onFailure emits null and turns off animation.
    @Test
    public void givenAppointmentReadAll_whenApiFailure_thenEmitNullAndStopAnimation() {
        AppointmentRepository repositoryUnderTest = new AppointmentRepository();
        Call<AppointmentReadAll> mockApiCall = mockCall();
    ...
    // Test Case ID: TC-REPO-015
    // Verify Appointment readByID success emits data and turns off animation.
    @Test
    public void givenAppointmentReadById_whenApiSuccess_thenEmitDataAndStopAnimation() {
        AppointmentRepository repositoryUnderTest = new AppointmentRepository();
        Call<AppointmentReadByID> mockApiCall = mockCall();
        AppointmentReadByID mockResponseBody = mock(AppointmentReadByID.class);
    ...
    // Test Case ID: TC-REPO-016
    // Verify Appointment readByID onFailure emits null and turns off animation.
    @Test
    public void givenAppointmentReadById_whenApiFailure_thenEmitNullAndStopAnimation() {
        AppointmentRepository repositoryUnderTest = new AppointmentRepository();
        Call<AppointmentReadByID> mockApiCall = mockCall();
        ...
        repositoryUnderTest.readByID(headers, "A1");
        capturedCallbackRef.get().onFailure(mockApiCall, new RuntimeException("connection refused"));

        assertEquals(null, repositoryUnderTest.getReadByIDResponse().getValue());
        assertEquals(Boolean.FALSE, repositoryUnderTest.getAnimation().getValue());
    }

    // Test Case ID: TC-REPO-017
    // Verify Booking create HTTP error emits null and turns off animation.
    @Test
    public void givenBookingCreateRequest_whenApiHttpError_thenEmitNullAndStopAnimation() {
        BookingRepository repositoryUnderTest = new BookingRepository();
        Call<BookingCreate> mockApiCall = mockCall();
        ...
        assertEquals(null, repositoryUnderTest.getBookingCreate().getValue());
        assertEquals(Boolean.FALSE, repositoryUnderTest.getAnimation().getValue());
    }

    // Test Case ID: TC-REPO-018
    // Verify Booking create onFailure emits null and turns off animation.
    @Test
    public void givenBookingCreateRequest_whenApiFailure_thenEmitNullAndStopAnimation() {
        BookingRepository repositoryUnderTest = new BookingRepository();
        Call<BookingCreate> mockApiCall = mockCall();
        ...
        repositoryUnderTest.create(headers, requestBody);
        capturedCallbackRef.get().onFailure(mockApiCall, new RuntimeException("server error"));

        assertEquals(null, repositoryUnderTest.getBookingCreate().getValue());
        assertEquals(Boolean.FALSE, repositoryUnderTest.getAnimation().getValue());
    }

    // Test Case ID: TC-REPO-019
    // Verify Booking readByID success emits data and turns off animation.
    @Test
    public void givenBookingReadById_whenApiSuccess_thenEmitDataAndStopAnimation() {
        BookingRepository repositoryUnderTest = new BookingRepository();
        Call<BookingReadByID> mockApiCall = mockCall();
        BookingReadByID mockResponseBody = mock(BookingReadByID.class);

        when(api.bookingReadByID(headers, "B1")).thenReturn(mockApiCall);
        AtomicReference<Callback<BookingReadByID>> capturedCallbackRef = captureCallback(mockApiCall);

        repositoryUnderTest.readByID(headers, "B1");
        capturedCallbackRef.get().onResponse(mockApiCall, Response.success(mockResponseBody));
    ...
    // Test Case ID: TC-REPO-020
    // Verify Booking readByID HTTP error emits null and turns off animation.
    @Test
    public void givenBookingReadById_whenApiHttpError_thenEmitNullAndStopAnimation() {
        BookingRepository repositoryUnderTest = new BookingRepository();
        Call<BookingReadByID> mockApiCall = mockCall();
    ...
    // Test Case ID: TC-REPO-021
    // Verify Booking readByID onFailure emits null and turns off animation.
    @Test
    public void givenBookingReadById_whenApiFailure_thenEmitNullAndStopAnimation() {
        BookingRepository repositoryUnderTest = new BookingRepository();
        Call<BookingReadByID> mockApiCall = mockCall();
    ...
    // Test Case ID: TC-REPO-022
    // Verify Booking readAll success emits data and turns off animation.
    @Test
    public void givenBookingReadAll_whenApiSuccess_thenEmitDataAndStopAnimation() {
        BookingRepository repositoryUnderTest = new BookingRepository();
        Call<BookingReadAll> mockApiCall = mockCall();
        BookingReadAll mockResponseBody = mock(BookingReadAll.class);
    ...
    // Test Case ID: TC-REPO-023
    // Verify Booking readAll HTTP error emits null and turns off animation.
    @Test
    public void givenBookingReadAll_whenApiHttpError_thenEmitNullAndStopAnimation() {
        BookingRepository repositoryUnderTest = new BookingRepository();
        Call<BookingReadAll> mockApiCall = mockCall();
    ...
    // Test Case ID: TC-REPO-024
    // Verify BookingPhoto readAll success emits data and turns off animation.
    @Test
    public void givenBookingPhotoReadAll_whenApiSuccess_thenEmitDataAndStopAnimation() {
        BookingPhotoRepository repositoryUnderTest = new BookingPhotoRepository();
        Call<BookingPhotoReadAll> mockApiCall = mockCall();
        BookingPhotoReadAll mockResponseBody = mock(BookingPhotoReadAll.class);
    ...
    // Test Case ID: TC-REPO-025
    // Verify BookingPhoto readAll onFailure emits null and turns off animation.
    @Test
    public void givenBookingPhotoReadAll_whenApiFailure_thenEmitNullAndStopAnimation() {
        BookingPhotoRepository repositoryUnderTest = new BookingPhotoRepository();
        Call<BookingPhotoReadAll> mockApiCall = mockCall();
    ...
    // Test Case ID: TC-REPO-026
    // Verify Doctor readAll HTTP error emits null and turns off animation.
    @Test
    public void givenDoctorReadAll_whenApiHttpError_thenEmitNullAndStopAnimation() {
        DoctorRepository repositoryUnderTest = new DoctorRepository();
        Call<DoctorReadAll> mockApiCall = mockCall();
    ...
    // Test Case ID: TC-REPO-027
    // Verify Doctor readAll onFailure emits null and turns off animation.
    @Test
    public void givenDoctorReadAll_whenApiFailure_thenEmitNullAndStopAnimation() {
        DoctorRepository repositoryUnderTest = new DoctorRepository();
        Call<DoctorReadAll> mockApiCall = mockCall();
    ...
    // Test Case ID: TC-REPO-028
    // Verify Doctor readById success emits data and turns off animation.
    @Test
    public void givenDoctorReadById_whenApiSuccess_thenEmitDataAndStopAnimation() {
        DoctorRepository repositoryUnderTest = new DoctorRepository();
        Call<DoctorReadByID> mockApiCall = mockCall();
        DoctorReadByID mockResponseBody = mock(DoctorReadByID.class);

        when(api.doctorReadByID(headers, "D1")).thenReturn(mockApiCall);
        AtomicReference<Callback<DoctorReadByID>> capturedCallbackRef = captureCallback(mockApiCall);

        repositoryUnderTest.readById(headers, "D1");
        capturedCallbackRef.get().onResponse(mockApiCall, Response.success(mockResponseBody));
    ...
    // Test Case ID: TC-REPO-029
    // Verify Doctor readById HTTP error emits null and turns off animation.
    @Test
    public void givenDoctorReadById_whenApiHttpError_thenEmitNullAndStopAnimation() {
        DoctorRepository repositoryUnderTest = new DoctorRepository();
        Call<DoctorReadByID> mockApiCall = mockCall();
    ...
    // Test Case ID: TC-REPO-030
    // Verify Doctor readById onFailure emits null and turns off animation.
    @Test
    public void givenDoctorReadById_whenApiFailure_thenEmitNullAndStopAnimation() {
        DoctorRepository repositoryUnderTest = new DoctorRepository();
        Call<DoctorReadByID> mockApiCall = mockCall();
        ...
        repositoryUnderTest.readById(headers, "D1");
        capturedCallbackRef.get().onFailure(mockApiCall, new RuntimeException("connection"));

        assertEquals(null, repositoryUnderTest.getReadByIdResponse().getValue());
        assertEquals(Boolean.FALSE, repositoryUnderTest.getAnimation().getValue());
    }

    // Test Case ID: TC-REPO-031
    // Verify Service readAll success emits data and turns off animation.
    @Test
    public void givenServiceReadAll_whenApiSuccess_thenEmitDataAndStopAnimation() {
        ServiceRepository repositoryUnderTest = new ServiceRepository();
        Call<ServiceReadAll> mockApiCall = mockCall();
        ServiceReadAll mockResponseBody = mock(ServiceReadAll.class);

        when(api.serviceReadAll(headers, params)).thenReturn(mockApiCall);
        AtomicReference<Callback<ServiceReadAll>> capturedCallbackRef = captureCallback(mockApiCall);
    ...
    // Test Case ID: TC-REPO-032
    // Verify Service readAll HTTP error emits null and turns off animation.
    @Test
    public void givenServiceReadAll_whenApiHttpError_thenEmitNullAndStopAnimation() {
        ServiceRepository repositoryUnderTest = new ServiceRepository();
        Call<ServiceReadAll> mockApiCall = mockCall();
    ...
    // Test Case ID: TC-REPO-033
    // Verify Service readByID success emits data and turns off animation.
    @Test
    public void givenServiceReadById_whenApiSuccess_thenEmitDataAndStopAnimation() {
        ServiceRepository repositoryUnderTest = new ServiceRepository();
        Call<ServiceReadByID> mockApiCall = mockCall();
        ServiceReadByID mockResponseBody = mock(ServiceReadByID.class);
    ...
    // Test Case ID: TC-REPO-034
    // Verify Speciality readAll onFailure emits null and turns off animation.
    @Test
    public void givenSpecialityReadAll_whenApiFailure_thenEmitNullAndStopAnimation() {
        SpecialityRepository repositoryUnderTest = new SpecialityRepository();
        Call<SpecialityReadAll> mockApiCall = mockCall();
    ...
    // Test Case ID: TC-REPO-035
    // Verify Speciality readById success emits data and turns off animation.
    @Test
    public void givenSpecialityReadById_whenApiSuccess_thenEmitDataAndStopAnimation() {
        SpecialityRepository repositoryUnderTest = new SpecialityRepository();
        Call<SpecialityReadByID> mockApiCall = mockCall();
        SpecialityReadByID mockResponseBody = mock(SpecialityReadByID.class);

        when(api.specialityReadByID(headers, "SK1")).thenReturn(mockApiCall);
        AtomicReference<Callback<SpecialityReadByID>> capturedCallbackRef = captureCallback(mockApiCall);

        repositoryUnderTest.readById(headers, "SK1");
        capturedCallbackRef.get().onResponse(mockApiCall, Response.success(mockResponseBody));
    ...
    // Test Case ID: TC-REPO-036
    // Verify Speciality readById HTTP error emits null and turns off animation.
    @Test
    public void givenSpecialityReadById_whenApiHttpError_thenEmitNullAndStopAnimation() {
        SpecialityRepository repositoryUnderTest = new SpecialityRepository();
        Call<SpecialityReadByID> mockApiCall = mockCall();
    ...
    // Test Case ID: TC-REPO-037
    // Verify Speciality readById onFailure emits null and turns off animation.
    @Test
    public void givenSpecialityReadById_whenApiFailure_thenEmitNullAndStopAnimation() {
        SpecialityRepository repositoryUnderTest = new SpecialityRepository();
        Call<SpecialityReadByID> mockApiCall = mockCall();
        ...
        repositoryUnderTest.readById(headers, "SK1");
        capturedCallbackRef.get().onFailure(mockApiCall, new RuntimeException("offline"));

        assertEquals(null, repositoryUnderTest.getReadByIdResponse().getValue());
        assertEquals(Boolean.FALSE, repositoryUnderTest.getAnimation().getValue());
    }

    // Test Case ID: TC-REPO-038
    // Verify Treatment readAll success emits data and turns off animation.
    @Test
    public void givenTreatmentReadAll_whenApiSuccess_thenEmitDataAndStopAnimation() {
        TreatmentRepository repositoryUnderTest = new TreatmentRepository();
        Call<TreatmentReadAll> mockApiCall = mockCall();
        TreatmentReadAll mockResponseBody = mock(TreatmentReadAll.class);

        when(api.treatmentReadAll(headers, "A1")).thenReturn(mockApiCall);
        AtomicReference<Callback<TreatmentReadAll>> capturedCallbackRef = captureCallback(mockApiCall);

        repositoryUnderTest.readAll(headers, "A1");
        capturedCallbackRef.get().onResponse(mockApiCall, Response.success(mockResponseBody));
    ...
    // Test Case ID: TC-REPO-039
    // Verify Treatment readAll HTTP error emits null and turns off animation.
    @Test
    public void givenTreatmentReadAll_whenApiHttpError_thenEmitNullAndStopAnimation() {
        TreatmentRepository repositoryUnderTest = new TreatmentRepository();
        Call<TreatmentReadAll> mockApiCall = mockCall();
    ...
    // Test Case ID: TC-REPO-040
    // Verify Treatment readAll onFailure emits null and turns off animation.
    @Test
    public void givenTreatmentReadAll_whenApiFailure_thenEmitNullAndStopAnimation() {
        TreatmentRepository repositoryUnderTest = new TreatmentRepository();
        Call<TreatmentReadAll> mockApiCall = mockCall();
        ...
        repositoryUnderTest.readAll(headers, "A1");
        capturedCallbackRef.get().onFailure(mockApiCall, new RuntimeException("no connection"));

        assertEquals(null, repositoryUnderTest.getReadAllResponse().getValue());
        assertEquals(Boolean.FALSE, repositoryUnderTest.getAnimation().getValue());
    }

    // Test Case ID: TC-REPO-041
    // Verify Treatment readByID HTTP error emits null and turns off animation.
    @Test
    public void givenTreatmentReadById_whenApiHttpError_thenEmitNullAndStopAnimation() {
        TreatmentRepository repositoryUnderTest = new TreatmentRepository();
        Call<TreatmentReadByID> mockApiCall = mockCall();
